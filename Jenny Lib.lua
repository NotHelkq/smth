...
do
	...
	function library.new(title : string)
		local container = utility:Create("ScreenGui", {
			...
			utility:Create("Frame", {
				...
				utility:Create("ImageLabel", {
					...
					Position = UDim2.new(0, -33, 0, -25),
					Size = UDim2.new(1.06, 30, 1.042, 30),
					ZIndex = 0,
		...
		container.Main.ResizeWindow.MouseButton1Up:Connect(function()
